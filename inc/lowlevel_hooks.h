/**
  ***************************************************************************************
  * @file    lowlevel_hooks.h
  * @author  £ukasz Kaümierczak
  * @version V1.0
  * @date    20/07/2013
  * @brief   This header file provides hooks operations set
  ***************************************************************************************
  * @copy
  *
...
*/
#ifndef LOWLEVEL_HOOKS_H
#define LOWLEVEL_HOOKS_H
...
class hooks {
public:
    static hooks &instance() { static hooks hinstance; return hinstance; }
    static const enum hookType{ HOOK_UNDEF=0, HOOK_KEYBOARD, HOOK_MOUSE, };

    static UINT_PTR hook_create(hookType type, LRESULT (CALLBACK *hkFct)(INT, WPARAM, LPARAM));
    static FunctionSuccesFailure hook_destroy(UINT_PTR hkHookRaw);
